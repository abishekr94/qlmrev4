...
; (function ($) {
    ...
    function toggleMenu1() {
        $(".header-menu-help").on("click", function () {
            $(".side-menu__block-help").addClass("active");
        });

        $(".side-menu__block-overlay-help,.side-menu__toggler-help, .scrollToLink").on(
            "click",
            function (e) {
                $(".side-menu__block-help").removeClass("active");
                e.preventDefault();
            }
        );
    }
